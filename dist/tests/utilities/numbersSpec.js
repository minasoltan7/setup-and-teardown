...
describe("Tests for numbers utilities", function () {
    describe("making sure that sum function get the sum of the 2 numbers given", function () {
    ...
    describe("making sure that multiply function multiplies the givens", function () {
